...
var defaultRefSet$1;
var getDefaultRefSet$1 = () => {
  if (!defaultRefSet$1) {
    defaultRefSet$1 = unstable_getInternalStates().refSet;
  }
...
var maybeProxify = (x) => typeof x === "object" ? proxy({ x }).x : x;
var isProxy = (x) => proxyStateMap.has(x);
var isProxySet = (obj) => {
